...
def main():
    ...
    if argv[1].lower() == '-h':
        print("This script will traverse the directory and delete all duplicate files from that directory.\n"
            "Scropt will write names of deleted files into a 'log' file and Log.txt will create into current directory")
        exit()
    if argv[1].lower() == '-u':
        print("Usage: Usage: Application Name Demo name of directory ")
        exit()
